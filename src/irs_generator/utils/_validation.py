...
def _finite_float(value: FloatConvertible, name: str) -> float:
    result = float(value)
...
def _positive_float(value: FloatConvertible, *, name: str) -> float:
...
def _non_negative(value: FloatConvertible, name: str) -> float:
    result = float(value)
...
def _validated_latitude(latitude_rad: FloatConvertible) -> float:
...
def _validate_dt(dt_s: FloatConvertible) -> float:
    dt = float(dt_s)
